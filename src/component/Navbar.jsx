...
//         {/* Logo */}
//         <div className="w-12 font-semibold cursor-pointer">
//           <img src={Logo} alt="Rohit verma Logo" />
//         </div>
...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw] ${isScrolled ? "bg-[#050414] bg-opacity-50 backdrop-blur-md shadow-md" : "bg-[#050411]"
        }`}
    >
      <div className="text-white py-5 flex justify-between items-center">
        {/* Logo */}
        <div className="w-12 rounded cursor-pointer">
          <img src={Profile} alt="Rohit Verma" />
        </div>
